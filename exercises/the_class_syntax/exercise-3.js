...
class Message {
  static DEFAULT_SENDER = new Contact(
    "The Orcaniser",
...
class Email extends Message {
  ...
  toString() {
    return `email from ${this.sender} to ${this.recipients.join(", ")}`
  }
}
...
const email = new Email(Message.DEFAULT_SENDER, contacts, "what's for lunch?")
